...
@Component({
  selector: 'app-krpan-crane-calculator-hints',
  standalone: true,
  imports: [TimelineModule, CardModule, CommonModule, InputSwitchModule, FormsModule],
  templateUrl: './krpan-crane-calculator-hints.component.html',
  styleUrl: './krpan-crane-calculator-hints.component.css'
})
export class KrpanCraneCalculatorHintsComponent {
  hints: HintItem[];
